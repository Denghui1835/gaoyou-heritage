...
const info = await m.evaluate(() => {
  ...
  const k = r(".hero-kicker"), h1 = r(".hero h1"), sub = r(".hero-sub"), btn = r(".hero-btn");
  return { kicker: k, h1, sub, btn, gapKickerH1: h1.top - k.bottom, gapH1Sub: sub.top - h1.bottom, gapSubBtn: btn.top - sub.bottom };
});
console.log(JSON.stringify(info, null, 2));
await m.screenshot({ path: "D:/新文科比赛/高邮网站/gaoyou-pages/screenshots/even-text.png", fullPage: false });
await browser.close();
