...
await page.screenshot({ path: "D:/新文科比赛/高邮网站/gaoyou-pages/screenshots/brutal-desktop.png", fullPage: false });
...
await m.screenshot({ path: "D:/新文科比赛/高邮网站/gaoyou-pages/screenshots/brutal-mobile.png", fullPage: false });
await browser.close();
console.log("done");
