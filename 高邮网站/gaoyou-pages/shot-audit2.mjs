...
const d = await page.evaluate(() => {
  ...
  return { portalBottom: Math.round(portal.bottom), heroBottom: Math.round(hero.bottom), vh: window.innerHeight, cardsAtBottom: hero.bottom - portal.bottom < 30 };
});
console.log("LAYOUT:", JSON.stringify(d));
await page.screenshot({ path: "D:/新文科比赛/高邮网站/gaoyou-pages/screenshots/audit2-desktop.png", fullPage: false });
...
await m.screenshot({ path: "D:/新文科比赛/高邮网站/gaoyou-pages/screenshots/audit2-mobile.png", fullPage: false });
await browser.close();
console.log("done");
